    ...
    >
      ...
      <div className="relative z-10 max-width px-4 sm:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          {/* Right - Combined Phone + Reviews + Code */}
          <div className="hidden lg:flex flex-col items-center gap-8">
            {/* Store badges above the phone */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <span className="text-dark-500 text-xs uppercase tracking-wider">Available on</span>
              <a
                href="https://play.google.com"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-white text-xs font-medium hover:bg-white/10 hover:border-green-400/50 transition-all duration-300"
              >
            ...
            {/* Phone Mockup — now shows app detail page with reviews */}
            <motion.div
              initial={{ opacity: 0, y: 40 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 1.2 }}
              className="w-[300px] h-[610px] relative flex-shrink-0"
            >
              <div className="absolute inset-0 rounded-[3rem] bg-gradient-to-b from-dark-600 to-dark-800 p-[3px] shadow-2xl shadow-accent-blue/20">
                <div className="w-full h-full rounded-[2.85rem] bg-dark-950 overflow-hidden relative">
                  ...
                  {/* Screen content — App Store / Google Play style */}
                  <div className="w-full h-full pt-8 pb-4 px-4 flex flex-col overflow-y-auto">
                    {/* Status bar */}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1 mt-0.5">
                          <div className="flex gap-0.5">
                            {[1,2,3,4,5].map(i => (
                              <FiStar key={i} className="text-yellow-400 fill-yellow-400" size={9} />
                            ))}
                          </div>
                    ...
                    <div className="flex items-center gap-2 mb-4 flex-shrink-0">
                      <div className="flex-1 py-2 rounded-full bg-accent-blue text-center text-white text-[11px] font-bold shadow-lg shadow-accent-blue/20">
                        Install
                      </div>
                    ...
                    <div className="flex gap-2 mb-4 flex-shrink-0 overflow-x-auto pb-1">
                      {["#1a1a2e", "#16213e", "#0f3460", "#1a1a2e"].map((color, i) => (
                        <div
                          key={i}
                          className="w-16 h-28 rounded-xl flex-shrink-0 border border-white/5 overflow-hidden"
                    ...
                    <div className="flex items-center gap-2 mb-3 bg-white/5 rounded-xl p-3 flex-shrink-0">
                      <div className="text-center flex-shrink-0">
                        ...
                        <div className="flex gap-0.5 justify-center">
                          {[1,2,3,4,5].map(i => (
                            <FiStar key={i} className="text-yellow-400 fill-yellow-400" size={8} />
                          ))}
                        </div>
                      </div>
                    ...
                    <div className="flex-1 min-h-0">
                      <motion.div
                        ...
                        className="bg-white/5 rounded-xl p-3 h-full"
                      >
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between">
                              ...
                              <span className="text-dark-500 text-[7px] flex items-center gap-1 flex-shrink-0">
                                <FiClock size={6} />
                                {review.date}
                              </span>
                            </div>
                            <div className="flex items-center gap-0.5">
                              {Array.from({ length: review.rating }).map((_, i) => (
                                <FiStar key={i} className="text-yellow-400 fill-yellow-400" size={7} />
                              ))}
                            </div>
                          </div>
                        </div>
              ...
              {techStack.slice(0, 8).map((tech, i) => {
                ...
                return (
                  <motion.span
                    ...
                    className="absolute z-20 px-3 py-1.5 text-[10px] font-semibold rounded-full bg-dark-800/90 backdrop-blur-md border border-white/10 text-dark-200 whitespace-nowrap shadow-lg"
