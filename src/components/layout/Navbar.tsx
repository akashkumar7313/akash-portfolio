  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? "bg-dark-950/70 backdrop-blur-2xl border-b border-white/[0.04] shadow-2xl shadow-black/20"
          : "bg-transparent"
      }`}
    >
      {/* Animated gradient line at top */}
      {scrolled && (
        <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-accent-blue/40 to-transparent" />
      )}
